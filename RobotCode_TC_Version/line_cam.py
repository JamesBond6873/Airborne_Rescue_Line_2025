...
def interpretPOI(poi, poi_no_crop, is_crop, max_black_top, bottom_point, averageLineAngleNormalized, turn_direction, last_bottom_point, averageLinePointX, entry):
    ...
    # === FORCED TURNS ===
        ...
        index = 2 if turn_direction == "left" else 1
...
def lineCamLoop():
    ...
    modelSilverLine = YOLO('/home/raspberrypi/Airborne_Rescue_Line_2025/Ai/models/silver_strip_v11/SilverStripDetection.onnx', task='classify')
